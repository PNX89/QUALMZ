...
def _resolves(claim: str) -> bool:
    ...
    `qualmz/thing.py` because that is the import path a reader types, and the file is at
    `src/qualmz/thing.py`. Both are correct and a check that refused the first would be wrong.
    """
